  ...
  return (
    <Grid container component="main" className={classes.root}>
      ...
      >
        ...
        <DialogContent>
          <form
            action={`/challenges/${props.challenge._id.toString()}/edit`}
            method="post"
          >
      ...
      <Helmet>
        <title>KAGGLE | MIS COMPETICIONES</title>
      </Helmet>
      <Grid item xs={12}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Breadcrumbs aria-label="breadcrumb">
                  <Link color="inherit" href={`/challenges`}>
                    Competiciones
                  </Link>
              ...
              <Grid item xs={12}>
                <div style={{ display: "flex" }}>
                  ...
                  <Button
                    ...
                    href={`/challenges/${props.challenge._id.toString()}/delete`}
                  >
                    <HighlightOffIcon />
                  </Button>
                </div>
